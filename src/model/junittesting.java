...
class junittesting {
	...
	@Test
	void fourWayBreakTestTwoTwoRecords() {
		//A = B > C = D
		...
		GroupA.updateMatch("Faze", "Legion", 2, 3); 
		...
		GroupA.updateMatch("Thieves", "Surge", 2, 3); 
		...
		GroupB.updateMatch("Optic","Legion", 2, 3); 
		GroupB.updateMatch("Optic", "Rokkr", 3, 2);
		GroupB.updateMatch("Optic", "Thieves", 3, 2); 
		GroupB.updateMatch("Optic", "Surge", 3, 2);  

		GroupB.updateMatch("Faze", "Surge", 3, 2);
		GroupB.updateMatch("Faze", "Legion", 2, 3); 
		GroupB.updateMatch("Faze","Thieves", 3, 2); 
		GroupB.updateMatch("Faze", "Rokkr", 2, 3); 

		GroupB.updateMatch("Thieves", "Rokkr", 3, 2); 
		GroupB.updateMatch("Thieves","Legion", 1, 3); 
		GroupB.updateMatch("Thieves", "Surge", 2, 3); 
		...
		assert(GroupB.pool.get(0).deadtie2);
		assert(GroupB.pool.get(1).deadtie2);
		...
		GroupC.updateMatch("Optic","Legion", 2, 3); 
		GroupC.updateMatch("Optic", "Rokkr", 3, 2);
		GroupC.updateMatch("Optic", "Thieves", 3, 2); 
		GroupC.updateMatch("Optic", "Surge", 3, 2);  

		GroupC.updateMatch("Faze", "Surge", 3, 2);
		GroupC.updateMatch("Faze", "Legion", 2, 3); 
		GroupC.updateMatch("Faze","Thieves", 3, 2); 
		GroupC.updateMatch("Faze", "Rokkr", 2, 3); 

		GroupC.updateMatch("Thieves", "Rokkr", 3, 2); 
		GroupC.updateMatch("Thieves","Legion", 1, 3); 
		GroupC.updateMatch("Thieves", "Surge", 2, 3); 
		...
		assert(GroupC.pool.get(0).deadtie2);
		assert(GroupC.pool.get(1).deadtie2);
		assertTrue(GroupC.pool.get(2).deadtie2);
		assertTrue(GroupC.pool.get(3).deadtie2);  


		//B(pool) >(pool) A > (pool)C > (pool) D
		Group GroupD = new Group("Faze","Optic","Thieves","Rokkr","Legion", "Surge");

		GroupD.updateMatch("Optic", "Faze", 2, 3); 
		GroupD.updateMatch("Optic","Legion", 2, 3); 
		GroupD.updateMatch("Optic", "Rokkr", 3, 2);
		GroupD.updateMatch("Optic", "Thieves", 3, 2); 
		GroupD.updateMatch("Optic", "Surge", 3, 1);  

		GroupD.updateMatch("Faze", "Surge", 3, 2);
		GroupD.updateMatch("Faze", "Legion", 2, 3); 
		GroupD.updateMatch("Faze","Thieves", 3, 2); 
		GroupD.updateMatch("Faze", "Rokkr", 2, 3); 

		GroupD.updateMatch("Thieves", "Rokkr", 3, 2); 
		GroupD.updateMatch("Thieves","Legion", 1, 3); 
		GroupD.updateMatch("Thieves", "Surge", 2, 3); 
		...
		assert(GroupD.pool.get(0).deadtie2);
		assert(GroupD.pool.get(1).deadtie2);
		...
		assert(GroupD.pool.get(2).deadtie2);
		assert(GroupD.pool.get(3).deadtie2);


		//B(pool) >(pool) A > (pool)D > (pool) C
		Group GroupE = new Group("Faze","Optic","Thieves","Rokkr","Legion", "Surge");

		GroupE.updateMatch("Optic", "Faze", 2, 3); 
		GroupE.updateMatch("Optic","Legion", 2, 3); 
		GroupE.updateMatch("Optic", "Rokkr", 3, 2);
		GroupE.updateMatch("Optic", "Thieves", 3, 2); 
		GroupE.updateMatch("Optic", "Surge", 3, 1);  

		GroupE.updateMatch("Faze", "Surge", 3, 0);
		GroupE.updateMatch("Faze", "Legion", 2, 3); 
		GroupE.updateMatch("Faze","Thieves", 3, 2); 
		GroupE.updateMatch("Faze", "Rokkr", 2, 3); 

		GroupE.updateMatch("Thieves", "Rokkr", 3, 2); 
		GroupE.updateMatch("Thieves","Legion", 1, 3); 
		GroupE.updateMatch("Thieves", "Surge", 2, 3); 
		...
		assert(GroupE.pool.get(0).deadtie2);
		assert(GroupE.pool.get(1).deadtie2);
		...
		assert(GroupE.pool.get(2).deadtie2);
		assert(GroupE.pool.get(3).deadtie2);
		...
		GroupF.updateMatch("Optic","Legion", 1, 3); 
		GroupF.updateMatch("Optic", "Rokkr", 3, 0);
		GroupF.updateMatch("Optic", "Thieves", 3, 2); 
		GroupF.updateMatch("Optic", "Surge", 3, 2);  

		GroupF.updateMatch("Faze", "Surge", 3, 2);
		GroupF.updateMatch("Faze", "Legion", 2, 3); 
		GroupF.updateMatch("Faze","Thieves", 3, 2); 
		GroupF.updateMatch("Faze", "Rokkr", 2, 3); 

		GroupF.updateMatch("Thieves", "Rokkr", 3, 2); 
		GroupF.updateMatch("Thieves","Legion", 1, 3); 
		GroupF.updateMatch("Thieves", "Surge", 2, 3); 
		...
		assert(GroupF.pool.get(0).deadtie2);
		assert(GroupF.pool.get(1).deadtie2);
		assert(GroupF.pool.get(2).deadtie2);
		assert(GroupF.pool.get(3).deadtie2);  

		//B>(map) A> D(map) C
		Group GroupG = new Group("Faze","Optic","Thieves","Rokkr","Legion", "Surge");

		GroupG.updateMatch("Optic", "Faze", 1, 3); 
		GroupG.updateMatch("Optic","Legion", 2, 3); 
		GroupG.updateMatch("Optic", "Rokkr", 3, 2);
		GroupG.updateMatch("Optic", "Thieves", 3, 2); 
		GroupG.updateMatch("Optic", "Surge", 3, 2);  

		GroupG.updateMatch("Faze", "Surge", 3, 2);
		GroupG.updateMatch("Faze", "Legion", 2, 3); 
		GroupG.updateMatch("Faze","Thieves", 3, 2); 
		GroupG.updateMatch("Faze", "Rokkr", 2, 3); 

		GroupG.updateMatch("Thieves", "Rokkr", 3, 2); 
		GroupG.updateMatch("Thieves","Legion", 2, 3); 
		GroupG.updateMatch("Thieves", "Surge", 2, 3); 
		...
		assert(GroupG.pool.get(0).deadtie2);
		assert(GroupG.pool.get(1).deadtie2);
		assert(GroupG.pool.get(2).deadtie2);
		assert(GroupG.pool.get(3).deadtie2);  

	}


	@Test
	void fourWayBreakTestTwoTwoRecords2() {
		//A = C > B = D
		Group GroupA = new Group("Faze","Optic","Thieves","Rokkr","Legion", "Surge");
		...
		GroupB.updateMatch("Optic","Legion", 2, 3); 
		GroupB.updateMatch("Optic", "Rokkr", 3, 2);
		GroupB.updateMatch("Optic", "Thieves", 2, 3); 
		GroupB.updateMatch("Optic", "Surge", 3, 2);  

		GroupB.updateMatch("Faze", "Surge", 3, 2);
		GroupB.updateMatch("Faze", "Legion", 3, 2); 
		GroupB.updateMatch("Faze","Thieves", 3, 2); 
		GroupB.updateMatch("Faze", "Rokkr", 2, 3); 

		GroupB.updateMatch("Thieves", "Rokkr", 2, 3); 
		GroupB.updateMatch("Thieves","Legion", 0, 3); 
		GroupB.updateMatch("Thieves", "Surge", 2, 3); 
		...
		GroupC.updateMatch("Optic","Legion", 2, 3); 
		GroupC.updateMatch("Optic", "Rokkr", 3, 2);
		GroupC.updateMatch("Optic", "Thieves", 2, 3); 
		GroupC.updateMatch("Optic", "Surge", 3, 0);  

		GroupC.updateMatch("Faze", "Surge", 3, 2);
		GroupC.updateMatch("Faze", "Legion", 3, 2); 
		GroupC.updateMatch("Faze","Thieves", 3, 2); 
		GroupC.updateMatch("Faze", "Rokkr", 2, 3); 

		GroupC.updateMatch("Thieves", "Rokkr", 2, 3); 
		GroupC.updateMatch("Thieves","Legion", 2, 3); 
		GroupC.updateMatch("Thieves", "Surge", 2, 3); 
		...
		//C(pool) >(pool) A > (pool)B > (pool) D
		Group GroupD = new Group("Faze","Optic","Thieves","Rokkr","Legion", "Surge");
		GroupD.updateMatch("Optic", "Faze", 3, 2); 
		GroupD.updateMatch("Optic","Legion", 2, 3); 
		GroupD.updateMatch("Optic", "Rokkr", 3, 2);
		GroupD.updateMatch("Optic", "Thieves", 2, 3); 
		GroupD.updateMatch("Optic", "Surge", 3, 0);  

		GroupD.updateMatch("Faze", "Surge", 3, 2);
		GroupD.updateMatch("Faze", "Legion", 3, 2); 
		GroupD.updateMatch("Faze","Thieves", 3, 2); 
		GroupD.updateMatch("Faze", "Rokkr", 2, 3); 

		GroupD.updateMatch("Thieves", "Rokkr", 2, 3); 
		GroupD.updateMatch("Thieves","Legion", 2, 3); 
		GroupD.updateMatch("Thieves", "Surge", 2, 3); 
		...
		//C(pool) >(pool) A > (pool)D > (pool) B
		Group GroupE = new Group("Faze","Optic","Thieves","Rokkr","Legion", "Surge");

		GroupE.updateMatch("Optic", "Faze", 3, 2); 
		GroupE.updateMatch("Optic","Legion", 2, 3); 
		GroupE.updateMatch("Optic", "Rokkr", 3, 2);
		GroupE.updateMatch("Optic", "Thieves", 2, 3); 
		GroupE.updateMatch("Optic", "Surge", 3, 0);  

		GroupE.updateMatch("Faze", "Surge", 3, 0);
		GroupE.updateMatch("Faze", "Legion", 3, 2); 
		GroupE.updateMatch("Faze","Thieves", 3, 2); 
		GroupE.updateMatch("Faze", "Rokkr", 2, 3); 

		GroupE.updateMatch("Thieves", "Rokkr", 2, 3); 
		GroupE.updateMatch("Thieves","Legion", 2, 3); 
		GroupE.updateMatch("Thieves", "Surge", 2, 3); 
		...
		GroupF.updateMatch("Optic","Legion", 0, 3); 
		GroupF.updateMatch("Optic", "Rokkr", 3, 2);
		GroupF.updateMatch("Optic", "Thieves", 2, 3); 
		GroupF.updateMatch("Optic", "Surge", 3, 2);  

		GroupF.updateMatch("Faze", "Surge", 3, 2);
		GroupF.updateMatch("Faze", "Legion", 3, 2); 
		GroupF.updateMatch("Faze","Thieves", 3, 2); 
		GroupF.updateMatch("Faze", "Rokkr", 0, 3); 

		GroupF.updateMatch("Thieves", "Rokkr", 2, 3); 
		GroupF.updateMatch("Thieves","Legion", 2, 3); 
		GroupF.updateMatch("Thieves", "Surge", 2, 3); 
		...
		GroupG.updateMatch("Optic","Legion", 2, 3); 
		GroupG.updateMatch("Optic", "Rokkr", 3, 0);
		GroupG.updateMatch("Optic", "Thieves", 2, 3); 
		GroupG.updateMatch("Optic", "Surge", 3, 2);  

		GroupG.updateMatch("Faze", "Surge", 3, 2);
		GroupG.updateMatch("Faze", "Legion", 3, 2); 
		GroupG.updateMatch("Faze","Thieves", 3, 2); 
		GroupG.updateMatch("Faze", "Rokkr", 2, 3); 
	...
	@Test
	void fourWayBreakTestTwoTwoRecords3() {
		//A = D > B = C
		Group GroupA = new Group("Faze","Optic","Thieves","Rokkr","Legion", "Surge");
		...
		GroupA.updateMatch("Faze", "Surge", 2, 3);
		GroupA.updateMatch("Faze", "Legion", 3, 2); 
		GroupA.updateMatch("Faze","Thieves", 3, 2); 
		GroupA.updateMatch("Faze", "Rokkr", 2, 3); 
		...
		//A >(pool) D > B = C
				...
				GroupB.updateMatch("Faze", "Surge", 0, 3);
				GroupB.updateMatch("Faze", "Legion", 3, 2); 
				GroupB.updateMatch("Faze","Thieves", 3, 2); 
				GroupB.updateMatch("Faze", "Rokkr", 2, 3); 

				GroupB.updateMatch("Thieves", "Rokkr", 2, 3); 
				GroupB.updateMatch("Thieves","Legion", 2, 3); 
				GroupB.updateMatch("Thieves", "Surge", 3, 2); 
				...
				GroupC.updateMatch("Faze", "Surge", 2, 3);
				GroupC.updateMatch("Faze", "Legion", 3, 2); 
				GroupC.updateMatch("Faze","Thieves", 3, 2); 
				GroupC.updateMatch("Faze", "Rokkr", 2, 3); 
				...
				GroupC.updateMatch("Thieves", "Rokkr", 2, 3); 
				GroupC.updateMatch("Thieves","Legion", 2, 3); 
				GroupC.updateMatch("Thieves", "Surge", 3, 2); 

				GroupC.updateMatch("Rokkr", "Legion",2, 3); 
				GroupC.updateMatch("Rokkr","Surge",3, 2); 

				GroupC.updateMatch("Legion", "Surge", 0, 3);
				GroupC.sortStandings();
				...
				GroupD.updateMatch("Faze", "Surge", 2, 3);
				GroupD.updateMatch("Faze", "Legion", 3, 2); 
				GroupD.updateMatch("Faze","Thieves", 3, 2); 
				GroupD.updateMatch("Faze", "Rokkr", 2, 3); 
				...
				GroupD.updateMatch("Thieves", "Rokkr", 2, 3); 
				GroupD.updateMatch("Thieves","Legion", 2, 3); 
				GroupD.updateMatch("Thieves", "Surge", 3, 2); 
				...
				GroupE.updateMatch("Faze", "Surge", 2, 3);
				GroupE.updateMatch("Faze", "Legion", 3, 2); 
				GroupE.updateMatch("Faze","Thieves", 3, 2); 
				GroupE.updateMatch("Faze", "Rokkr", 2, 3); 
				...
				GroupE.updateMatch("Thieves", "Rokkr", 2, 3); 
				GroupE.updateMatch("Thieves","Legion", 2, 3); 
				GroupE.updateMatch("Thieves", "Surge", 3, 2); 
				...
				GroupF.updateMatch("Faze", "Surge", 2, 3);
				GroupF.updateMatch("Faze", "Legion", 3, 2); 
				GroupF.updateMatch("Faze","Thieves", 3, 2); 
				GroupF.updateMatch("Faze", "Rokkr", 2, 3); 
				...
				GroupF.updateMatch("Thieves", "Rokkr", 2, 3); 
				GroupF.updateMatch("Thieves","Legion", 2, 3); 
				GroupF.updateMatch("Thieves", "Surge", 3, 2); 
				...
				GroupG.updateMatch("Faze", "Surge", 2, 3);
				GroupG.updateMatch("Faze", "Legion", 3, 0); 
				GroupG.updateMatch("Faze","Thieves", 3, 2); 
				GroupG.updateMatch("Faze", "Rokkr", 2, 3); 

				GroupG.updateMatch("Thieves", "Rokkr", 2, 3); 
				GroupG.updateMatch("Thieves","Legion", 2, 3); 
				GroupG.updateMatch("Thieves", "Surge", 3, 2); 
	...
	@Test
	void fourWayBreakTestTwoTwoRecords4() {
		Group GroupA = new Group("Faze","Optic","Thieves","Rokkr","Legion", "Surge");
		...
		GroupB.updateMatch("Optic", "Faze", 2, 3); 
		GroupB.updateMatch("Optic","Legion", 3, 2); 
		GroupB.updateMatch("Optic", "Rokkr", 3, 2);
		GroupB.updateMatch("Optic", "Thieves", 2, 3); 
		GroupB.updateMatch("Optic", "Surge", 3, 2);  

		GroupB.updateMatch("Faze", "Surge", 2, 3);
		GroupB.updateMatch("Faze", "Legion", 2, 3); 
		GroupB.updateMatch("Faze","Thieves", 3, 2); 
		...
		GroupB.sortStandings();
		assertTrue(GroupB.pool.get(0).deadtie2);
	...
	void threeOHTest1() {
		...
		GroupA.sortStandings();
		assert(GroupA.pool.get(0).deadtie3);
		...
		GroupB.updateMatch("Optic", "Faze", 2, 3); 
		GroupB.updateMatch("Optic","Legion", 3, 2); 
		GroupB.updateMatch("Optic", "Rokkr", 2, 3);
		GroupB.updateMatch("Optic", "Thieves", 3, 2); 
		GroupB.updateMatch("Optic", "Surge", 3, 2);  
		...
		GroupB.sortStandings();
		assert(GroupB.pool.get(0).deadtie3);
		...
		GroupC.updateMatch("Optic", "Faze", 3, 2); 
		GroupC.updateMatch("Optic","Legion", 3, 2); 
		GroupC.updateMatch("Optic", "Rokkr", 3, 2);
		GroupC.updateMatch("Optic", "Thieves", 2, 3); 
		...
		GroupC.sortStandings();
		assert(GroupC.pool.get(0).deadtie3);
		...
		GroupD.updateMatch("Faze", "Surge", 2, 3);
		GroupD.updateMatch("Faze", "Legion", 3, 2); 
		GroupD.updateMatch("Faze","Thieves", 2, 3); 
		...
		GroupD.sortStandings();
		assert(GroupD.pool.get(0).deadtie3);
	...
	void OHthreeTest1() {
		...
		GroupB.updateMatch("Faze", "Surge", 2, 3);
		GroupB.updateMatch("Faze", "Legion", 2, 3); 
		GroupB.updateMatch("Faze","Thieves", 2, 3); 
		GroupB.updateMatch("Faze", "Rokkr", 3, 2); 

		GroupB.updateMatch("Thieves", "Rokkr", 2, 3); 
		GroupB.updateMatch("Thieves","Legion", 3, 2); 
		GroupB.updateMatch("Thieves", "Surge", 2, 3); 
		...
		assertTrue(GroupB.pool.get(2).deadtie3);
		assertTrue(GroupB.pool.get(3).deadtie3);
		assertTrue(GroupB.pool.get(4).deadtie3);
		assert(GroupB.pool.get(5).deadtie3);
		
		Group GroupC = new Group("Faze","Optic","Thieves","Rokkr","Legion", "Surge");

		GroupC.updateMatch("Optic", "Faze", 2, 3); 
		GroupC.updateMatch("Optic","Legion", 2, 3); 
		GroupC.updateMatch("Optic", "Rokkr", 2, 3);
		GroupC.updateMatch("Optic", "Thieves", 3, 2); 
		GroupC.updateMatch("Optic", "Surge", 3, 2);  

		GroupC.updateMatch("Faze", "Surge", 2, 3);
		GroupC.updateMatch("Faze", "Legion", 3, 2); 
		GroupC.updateMatch("Faze","Thieves", 2, 3); 
		GroupC.updateMatch("Faze", "Rokkr", 2, 3); 

		GroupC.updateMatch("Thieves", "Rokkr", 3, 2); 
		GroupC.updateMatch("Thieves","Legion", 3, 2); 
		GroupC.updateMatch("Thieves", "Surge", 3, 2); 
		...
		assertTrue(GroupC.pool.get(2).deadtie3);
		assertTrue(GroupC.pool.get(3).deadtie3);
		assertTrue(GroupC.pool.get(4).deadtie3);
		assert(GroupC.pool.get(5).deadtie3);
		...
		GroupD.updateMatch("Thieves", "Rokkr", 3, 2); 
		GroupD.updateMatch("Thieves","Legion", 3, 2); 
		GroupD.updateMatch("Thieves", "Surge", 3, 2); 
		...
		assertTrue(GroupD.pool.get(2).deadtie3);
		assertTrue(GroupD.pool.get(3).deadtie3);
		assertTrue(GroupD.pool.get(4).deadtie3);
		assert(GroupD.pool.get(5).deadtie3);
	}
	
	@Test
	void OHthreeMapTest1() {
		Group GroupA = new Group("Faze","Optic","Thieves","Rokkr","Legion", "Surge");
		...
		GroupA.updateMatch("Faze", "Surge", 0, 3);
		GroupA.updateMatch("Faze", "Legion", 3, 2); 
		GroupA.updateMatch("Faze","Thieves", 2, 3); 
		GroupA.updateMatch("Faze", "Rokkr", 2, 3); 
		...
		assertTrue(GroupA.pool.get(2).deadtie2);
		assertTrue(GroupA.pool.get(3).deadtie2);
		assert(GroupA.pool.get(4).deadtie3);
		assert(GroupA.pool.get(5).deadtie3);
		
	}
	@Test
	void OHthreeMapTest2() {
		Group GroupA = new Group("Faze","Optic","Thieves","Rokkr","Legion", "Surge");
		...
		GroupA.sortStandings();
		assert(GroupA.pool.get(2).deadtie2);
		assert(GroupA.pool.get(3).deadtie2);
		assert(GroupA.pool.get(4).deadtie3);
		assert(GroupA.pool.get(5).deadtie3);
		
	}
	@Test
	void OHthreeMapTest3() {
		Group GroupA = new Group("Faze","Optic","Thieves","Rokkr","Legion", "Surge");
	...
	void OHthreeMapTest5() {
		...
		GroupA.updateMatch("Faze", "Surge", 2, 3);
		GroupA.updateMatch("Faze", "Legion", 3, 0); 
		GroupA.updateMatch("Faze","Thieves", 2, 3); 
		GroupA.updateMatch("Faze", "Rokkr", 2, 3); 
	...
	@Test
	void OHthreeMapTest9() {
		Group GroupA = new Group("Faze","Optic","Thieves","Rokkr","Legion", "Surge");

		GroupA.updateMatch("Optic", "Faze", 2, 3); 
		GroupA.updateMatch("Optic","Legion", 3, 1); 
		GroupA.updateMatch("Optic", "Rokkr", 3, 2);
		GroupA.updateMatch("Optic", "Thieves", 2, 3); 
		GroupA.updateMatch("Optic", "Surge", 2, 3);  

		GroupA.updateMatch("Faze", "Surge", 2, 3);
		GroupA.updateMatch("Faze", "Legion", 3, 1); 
		GroupA.updateMatch("Faze","Thieves", 2, 3); 
		GroupA.updateMatch("Faze", "Rokkr", 2, 3); 
	...
	void OHthreePoolTest3() {
		...
		GroupA.updateMatch("Faze", "Surge", 1, 3);
		GroupA.updateMatch("Faze", "Legion", 3, 2); 
		GroupA.updateMatch("Faze","Thieves", 2, 3); 
		GroupA.updateMatch("Faze", "Rokkr", 2, 3); 
	...
	@Test
	void OHthreePoolTest10() {
		Group GroupA = new Group("Faze","Optic","Thieves","Rokkr","Legion", "Surge");

		GroupA.updateMatch("Optic", "Faze", 2, 3); 
		GroupA.updateMatch("Optic","Legion", 3, 2); 
		GroupA.updateMatch("Optic", "Rokkr", 3, 2);
		GroupA.updateMatch("Optic", "Thieves", 0, 3); 
		GroupA.updateMatch("Optic", "Surge", 0, 3);  
	...
	void TheeWayBreak5() {
		...
		GroupA.updateMatch("Optic", "Faze", 2, 3); 
		GroupA.updateMatch("Optic","Legion", 3, 2); 
		GroupA.updateMatch("Optic", "Rokkr", 0, 3);
		GroupA.updateMatch("Optic", "Thieves", 2, 3); 
		GroupA.updateMatch("Optic", "Surge", 2, 3);  
